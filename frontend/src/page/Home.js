...
import HomeCard from '../componenet/HomeCard'
import { useSelector } from 'react-redux'
import CardFeature from '../componenet/CardFeature'
import {GrPrevious, GrNext} from "react-icons/gr"
import FilterProduct from '../componenet/FilterProduct'
...
const Home = () => {
  ...
  return (
    <div className='p-2 mid:p-4'>
      <div className='md:flex gap-4 py-2'>

        <div className='md:w-1/2'>
          <div className='flex gap-3 bg-slate-300 w-36 px-2 items-center rounded-full'>
            <p className='text-sm font-medium text-slate-900'>Bike Delivery</p>
            <img src='https://cdn-icons-png.flaticon.com/512/2972/2972185.png' className='h-7'></img>
          </div>
